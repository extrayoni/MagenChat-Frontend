    ...
    <div style={{ minHeight: '100vh', background: '#F2FAF6', padding: '60px 6vw' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 24, padding: '48px 40px', boxShadow: '0 20px 50px -30px rgba(16,38,31,.25)', display: 'flex', flexDirection: 'column', gap: 40 }}>
          {[
            { title: '1. איסוף מידע', body: "מגןצ'אט אוסף מידע מינימלי הדרוש לפעולת השירות: קישור לקבוצת הוואטסאפ, מספר טלפון לקבלת התרעות, שם ופרטי תשלום לצורך חיוב, וכתובת אימייל לקבלות ועדכונים." },
            ...
            { title: '4. אבטחת מידע', body: "אנו נוקטים באמצעי אבטחה מתקדמים: הצפנה מלאה של כל התקשורת, שרתים מאובטחים, גישה מוגבלת לצוות טכני בלבד, ומחיקה אוטומטית של נתונים זמניים." },
            { title: '5. זכויותיכם', body: "יש לכם זכות לבקש מחיקת המידע האישי שלכם, לעדכן פרטי קשר, להפסיק את השירות בכל עת, ולקבל מידע על השימוש בנתונים שלכם." },
          ].map(s => (
            <section key={s.title}>
