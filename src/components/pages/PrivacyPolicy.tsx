      ...
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 24, padding: '48px 40px', boxShadow: '0 20px 50px -30px rgba(16,38,31,.25)', display: 'flex', flexDirection: 'column', gap: 40 }}>
          {[
            ...
            { title: '2. עיבוד תוכן ושמירת מידע', body: "המערכת מנתחת תוכן בקבוצות הוואטסאפ בזמן אמת — הודעות טקסט, הקלטות קוליות, תמונות וקישורים. תוכן ההודעות מנותח אוטומטית ואינו נשמר במערכת מעבר לרגע הסריקה. לוגים של אירועי חסימה (סוג תוכן, שעה, סיבה) נשמרים עד 90 יום לצורך דיווח לאחראי הקבוצה ולאחר מכן נמחקים. אין גישה אנושית לתוכן הקבוצות." },
            ...
            { title: '6. זכויותיכם', body: "בהתאם לחוק הגנת הפרטיות הישראלי, יש לכם זכות לבקש מחיקת המידע האישי שלכם, לעדכן פרטי קשר, להפסיק את השירות בכל עת, ולקבל מידע על השימוש בנתונים שלכם. לפניות פנו אלינו בטלפון המצוין להלן." },
          ].map(s => (
            <section key={s.title}>
