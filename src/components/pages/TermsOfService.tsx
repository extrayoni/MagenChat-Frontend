    ...
    <div style={{ minHeight: '100vh', background: '#F2FAF6', padding: '60px 6vw' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 24, padding: '48px 40px', boxShadow: '0 20px 50px -30px rgba(16,38,31,.25)', display: 'flex', flexDirection: 'column', gap: 40 }}>
          {[
            { title: '1. הסכמה לתנאים', body: "השימוש בשירות מגןצ'אט מהווה הסכמה לתנאי שימוש אלו. הרישום לשירות מיועד להורים, מורים ואנשי חינוך בני 18 ומעלה בלבד — השירות עצמו נועד להגן על ילדים בקבוצות הוואטסאפ שלהם. אם אינכם מסכימים לתנאים, נא הימנעו מהשימוש בשירות." },
            { title: '2. תיאור השירות', body: "מגןצ'אט מספק שירות סינון אוטומטי של תוכן בקבוצות וואטסאפ, כולל זיהוי ומחיקה של שפה פוגענית, תמונות לא ראויות, הקלטות קוליות בעייתיות וקישורים מסוכנים. השירות נמצא כעת בשלב בטא וזמין ללא עלות. השירות תלוי בתשתיות וואטסאפ ועשוי להיות מושפע משינויים במדיניות וואטסאפ שאינם בשליטתנו." },
            ...
            { title: '4. אחריות מנהל הקבוצה', body: "המוסיף את מגןצ'אט לקבוצת הוואטסאפ אחראי לידע ולהסכמה של חברי הקבוצה לכך שהתוכן נסרק אוטומטית לצורכי הגנה. מגןצ'אט אינו נושא באחריות לאי-עמידה בהוראה זו." },
            { title: '5. שלב הבטא', body: "השירות מוצע כרגע ללא עלות כחלק מתוכנית בטא. אנו שומרים על הזכות לשנות את מודל התמחור בסוף תקופת הבטא, עם הודעה מראש למשתמשים." },
            { title: '6. אחריות ומגבלות', body: "מגןצ'אט מספק הגנה מיטבית אך אינו ערב לחסימת 100% מהתוכן הפוגעני. השירות מוצע As-Is ולא נישא באחריות לנזקים עקיפים." },
            { title: '7. שינויים בתנאים', body: "אנו שומרים על הזכות לעדכן תנאים אלו בכל עת. שינויים מהותיים יפורסמו מראש. המשך השימוש בשירות לאחר השינוי מהווה הסכמה לתנאים החדשים." },
            { title: '8. דין חל וסמכות שיפוטית', body: "תנאים אלו כפופים לדיני מדינת ישראל. לבתי המשפט המוסמכים בתל אביב-יפו תהא סמכות שיפוטית ייחודית לכל סכסוך הנובע מתנאים אלו או מהשימוש בשירות." },
          ].map(s => (
            <section key={s.title}>
