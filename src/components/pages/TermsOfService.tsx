      ...
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 24, padding: '48px 40px', boxShadow: '0 20px 50px -30px rgba(16,38,31,.25)', display: 'flex', flexDirection: 'column', gap: 40 }}>
          {[
            ...
            { title: '2. תיאור השירות', body: "מגןצ'אט מספק שירות סינון אוטומטי של תוכן בקבוצות וואטסאפ, כולל זיהוי ומחיקה של שפה פוגענית, תמונות לא ראויות, הקלטות קוליות בעייתיות וקישורים מסוכנים. השירות נמצא כעת בשלב בטא וזמין ללא עלות." },
            ...
            { title: '4. שלב הבטא', body: "השירות מוצע כרגע ללא עלות כחלק מתוכנית בטא. אנו שומרים על הזכות לשנות את מודל התמחור בסוף תקופת הבטא, עם הודעה מראש למשתמשים." },
